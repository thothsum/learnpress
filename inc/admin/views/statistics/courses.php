...
<div id="learn-press-statistic" class="learn-press-statistic-courses">
    <ul class="subsubsub chart-buttons">
        <li>
            <button class="button" data-type="course-last-7-days"
        ...
        <li>
            <button class="button"
                    data-type="course-last-12-months"><?php _e( 'Last 12 Months', 'learnpress' ); ?></button>
        </li>
        <li>
        ...
        <li>
            <form id="course-custom-time">
                ...
                <button class="button button-primary" data-type="course-custom-time" type="submit"
    ...
    <ul class="chart-description">
        ...
        <li class="public"><span><?php _e( 'Public', 'learnpress' ); ?></span></li>
        <li class="pending"><span><?php _e( 'Pending', 'learnpress' ); ?></span></li>
        <li class="paid"><span><?php _e( 'Paid', 'learnpress' ); ?></span></li>
