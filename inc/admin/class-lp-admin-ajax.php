...
if (!class_exists('LP_Admin_Ajax')) {
    ...
    class LP_Admin_Ajax
    {
         ...
         * @since 3.2.7.8
         * @author hungkv
         * Ajax click update order export
         */
        public static function update_order_exports()
        {
            ...
            <div class="lp-invoice__header">
                ...
                <div class="lp-invoice__hright">
                    <?php if ($site_title === 'check'): ?>
                        <p><?php echo esc_html(get_bloginfo('name')); ?></p>
                    <?php endif; ?>
                    <?php if ($order_date === 'check'): ?>
